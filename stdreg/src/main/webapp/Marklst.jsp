            ...
            <div class="card ">
                <div class="card-header">
                  <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Stdlist.jsp">Registered Students</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="#">All student result</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card-body" style="background-image: url(pexels-pixabay-267885.jpg);background-size: 100%;">
                    ...
                    <td><%=rs.getString("Engg_phy")%></td>
                    <td><%=rs.getString("Engg_che")%></td>
                    <td><%=rs.getString("Engg_math")%></td>
                    <td><%=rs.getString("Engg_grap")%></td>
                    <td><%=rs.getString("Electronics")%></td>
                    </tr>
                    <%} %>
                    </table>
                </div>
